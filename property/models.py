...
class Flat(models.Model):
    ...
    owners_phonenumber_pure = PhoneNumberField(blank=True)
...
class Complaint(models.Model):
    user = models.ForeignKey(User, verbose_name="Кто пожаловался", null=True, on_delete=models.SET_NULL)
    flat = models.ForeignKey(Flat, verbose_name="Квартира, на которую пожаловались", null=True, on_delete=models.SET_NULL)
...
class Owner(models.Model):
    ...
    phonenumber_pure = PhoneNumberField(blank=True)
